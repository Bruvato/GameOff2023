...
{
    const string privateCode = "S0F9ysYII0O-7fz0SnUo8gHbJ76YeOVEqjcXVvvqI88A";  //Key to Upload New Info
    const string publicCode = "656c31c28f40bb1054d48762";   //Key to download
    const string webURL = "http://dreamlo.com/lb/"; //  Website the keys are for
    // http://dreamlo.com/lb/S0F9ysYII0O-7fz0SnUo8gHbJ76YeOVEqjcXVvvqI88A
